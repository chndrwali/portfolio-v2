...
const Hero = () => {
  ...
  return (
    <section className="py-12 xl:py-24 h-[84vh] mb-14 xl:mb-10 xl:pt-10 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none  ">
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8 ">
          ...
          <div className="hidden xl:flex relative">
            ...
            <DevImg containerStyles="bg-hero_shape w-[510px] h-[462px] bg-no-repeat relative bg-bottom" imgStyles='rounded-br-full' imgSrc="/hero/developer.webp" />
          </div>
        </div>
